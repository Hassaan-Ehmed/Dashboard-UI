...
function CoverSection() {
  return (
   ...
   <div style={{width:"100%",display:"flex",justifyContent:"center",alignItems:"center"}}>
    ...
    <div style={{width:"98%",height:"50vh",marginTop:"10px",boxShadow:"0px 3px 20px -11px",display:"flex",flexDirection:"column",justifyContent:"space-between",alignItems:"center",backgroundColor:"white",paddingTop:"30px"}} >
...
<div style={{height:"9.5vw",width:"9.5vw",borderRadius:"50%",position:"absolute",top:-30,left:10,boxSizing:"border-box"}}> 
...
<p style={{fontSize:"1.2vw",fontWeight:"600",color:"#A7172A"}}>Test Review 1</p>
